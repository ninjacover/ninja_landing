            ...
            <footer className="footer-top-area pt-100 pb-70">
                <div className="container">
                    <div className="row">
                        ...
                        <img src="/images/NinjaWhite.png" alt="logo"  style={{width:'70%',height:'125px'}}></img>
                            ...
                            <div className="single-widget contact">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <span>Address:</span> 
                                        3, st 203, Degla suare, Maadi City 
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-widget">
                                ...
                                <p className="newsletter-p">To have further offers sent on email to you  . please leave your email below.</p>
